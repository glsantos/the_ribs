...
CREATE TABLE `tbl_caixa_entrada` (
  ...
  KEY `fk_entrada_caixa_idx` (`id_entrada`),
  CONSTRAINT `fk_caixa_entrada` FOREIGN KEY (`id_caixa`) REFERENCES `tbl_caixa` (`id_caixa`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_entrada_caixa` FOREIGN KEY (`id_entrada`) REFERENCES `tbl_entrada` (`id_entrada`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tbl_clientes` VALUES (1,'Giovanna','Silva Resende','585106691','32931588890','gi','123'),(2,'Marcelo Bruno','Oliveira Santos de Farias','585106691','32931588890','bruno','123');
...
CREATE TABLE `tbl_funcionarios` (
  ...
  CONSTRAINT `cargo_funcionario` FOREIGN KEY (`id_cargo`) REFERENCES `tbl_cargos` (`id_cargo`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `endereco_funcionario` FOREIGN KEY (`id_endereco`) REFERENCES `tbl_enderecos` (`id_endereco`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `unidade_funcionario` FOREIGN KEY (`id_unidade`) REFERENCES `tbl_unidades` (`id_unidade`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-09-29  0:54:06
